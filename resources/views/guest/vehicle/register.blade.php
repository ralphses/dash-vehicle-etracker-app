<x-guest-layout>
    ...
    <div class="container mx-auto px-6 lg:px-20 mt-8 bg-white p-8 rounded-md shadow-md max-w-md mb-10">
        <!-- Registration Form -->
        <form id="registrationForm" action="{{ route('vehicle.register') }}" method="POST">
            @csrf
            ...
            <div class="form-section" id="section1">
                ...
                <!-- Add other form fields for section 1 as needed -->
            ...
            <div class="form-section hidden" id="section2">
                <div class="mb-4">
                    <label for="vehicle_registration" class="block text-gray-700 text-sm font-semibold mb-2">Vehicle Registration Number</label>
                    <input type="text" id="vehicle_registration_number" name="vehicle_registration_number" class="w-full px-4 py-2 border rounded-md" value="{{ session()->has('number') ? session('number') : "" }}">
                ...
                <div class="mb-4">
                    <label for="means_of_purchase" class="block text-gray-700 text-sm font-semibold mb-2">Vehicle type</label>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="vehicle_model" name="vehicle_model" class="w-full px-4 py-2 border rounded-md">
                    @error('vehicle_model')
                        <p class="text-red-700" style="color: red">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="vehicle_color" name="vehicle_color" class="w-full px-4 py-2 border rounded-md">
                    @error('vehicle_color')
                        <p class="text-red-700" style="color: red">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    <label for="means_of_purchase" class="block text-gray-700 text-sm font-semibold mb-2">Means of Purchase</label>
                ...
                <button type="submit" class="w-full bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-full font-semibold">Register Vehicle</button>
            </div>
        </form>
    </div>
    <x-footer />
