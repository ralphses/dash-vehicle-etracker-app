    ...
    <div class="container mx-auto px-6 lg:px-20 mt-8 bg-white p-8 rounded-md shadow-md max-w-md mb-10">
        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="vehicle_registration" name="vehicle_registration" class="w-full px-4 py-2 border rounded-md">
            </div>
            <div class="mb-4">
            ...
            <button type="submit" class="w-full bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-full font-semibold">Register</button>
        </form>
    </div>
    <x-footer />
</x-guest-layout>
